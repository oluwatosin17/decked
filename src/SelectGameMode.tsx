...
export default function SelectGameMode({ onBack, onSelect }: Props) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        padding: '60px 40px', position: 'relative', zIndex: 2, gap: '40px',
      }}>
        {/* Title with entrance animation */}
        <h1 style={{
          fontFamily: "'Anton SC', sans-serif", fontWeight: 400,
          fontSize: '40px', color: '#fff', margin: 0,
            ...
            return (
              ...
              >
                ...
                <div style={{
                  ...
                  ...(isHovered ? { background: 'rgba(255,255,255,0.13)' } : {}),
                }}>
                  <img
                    src={mode.icon}
                    alt={mode.label}
      ...
      <footer style={{
        background: 'rgba(5,5,12,0.72)', backdropFilter: 'blur(4px)',
        padding: '32px 60px', display: 'flex', flexDirection: 'column', gap: '40px',
