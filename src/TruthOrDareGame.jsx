...
/* ─── Screen 1: Age Gate ─── */
function AgeGate({ onBack, onConfirm }) {
  return (
...
function PlayerSetup({ players, setPlayers, onSkip, onNext }) {
...
/* ─── Screen 3: Game Play ─── */
function GamePlay({ players, onBack }) {
